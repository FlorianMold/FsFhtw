...
let private generateTrips: list<Trip> =
...
let private createTicketForTrip
    ...
    { ticketNr = { nr = ticketNumber }
      ...
      // TODO: random traintype
      trainType = Railjet
      // TODO: lock type
      departureTime = DateTime.Now
      arrivalTime = DateTime.Now }

/// Defines how much tickets are generated by the application
...
let rec private createTicketFromTicketType (types: list<TicketType>) (ticketNumber: int) (trip: Trip) : list<Ticket> =
    match types with
    | t :: types ->
        ...
        createTicketForTrip trip ticketNumber ticketPriceByTicketType t
        :: createTicketFromTicketType types ticketNumber trip
    | [] -> []
...
let private generateTickets (trip: Trip) (ticketNumber: int) : list<Ticket> =
    ...
    Seq.init randomTicketAmount (fun _ -> createTicketFromTicketType ticketTypes ticketNumber trip)
    |> List.concat
